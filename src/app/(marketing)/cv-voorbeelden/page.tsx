...
import { CvExampleGallery } from "@/components/marketing/cv-example-gallery";
...
export const metadata: Metadata = {
  title: "CV-voorbeelden per beroep: bekijk en gebruik direct",
  description:
    "Bekijk professionele cv-voorbeelden per beroep, van administratief medewerker tot software engineer. Filter, zoek en gebruik een voorbeeld als basis voor jouw eigen cv.",
...
export default function CvVoorbeeldenPage() {
  ...
  const itemListJsonLd = {
    ...
    itemListElement: examples.map((ex, i) => ({
      "@type": "ListItem",
      position: i + 1,
      name: `CV-voorbeeld ${ex.profession}`,
    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-[#E5E3DA] py-20 sm:py-28">
        ...
        <div className="container-shell relative text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-[#56564F]">
            Bekijk volledig ingevulde cv-voorbeelden per beroep. Klik op een voorbeeld voor de complete
            uitwerking met profieltekst, werkervaring en tips, en gebruik het als basis voor je eigen cv.
          </p>
          <Link
            href="/registreren"
      ...
      <section className="py-20 sm:py-24">
        <div className="container-shell">
          <div className="mx-auto mb-12 max-w-2xl rounded-2xl border border-[#E5E3DA] bg-[#F2F1EC] px-6 py-5 text-center">
            <p className="text-sm font-bold text-[#111113]">Zijn cv-voorbeelden slim als startpunt?</p>
            <p className="mt-2 text-sm leading-6 text-[#56564F]">
              Ja. Zien hoe een sterk cv eruitziet in jouw vakgebied geeft direct houvast: je weet welke
              secties recruiters verwachten, welke toon werkt en waar je je kunt onderscheiden. Kies een
              voorbeeld dat bij je past en pas het in een paar minuten aan.
            </p>
          </div>

          <CvExampleGallery examples={examples} />
        </div>
      </section>
        ...
        <div className="container-shell overflow-hidden rounded-3xl bg-[#111113] px-6 py-16 sm:px-14 sm:py-20">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
              <Link href="/registreren" className="inline-flex items-center gap-2 rounded-lg bg-[#C6F24E] px-7 py-3.5 text-[15px] font-black text-[#111113] transition-colors hover:bg-[#DCF58A]">
                Start gratis <ArrowRight className="size-4" />
              </Link>
              <Link href="/cv-templates" className="inline-flex items-center gap-2 rounded-lg border border-white/10 px-7 py-3.5 text-[15px] font-semibold text-[#F2F1EC] transition-colors hover:bg-white/5">
                Bekijk templates
              </Link>
            </div>
          </div>
