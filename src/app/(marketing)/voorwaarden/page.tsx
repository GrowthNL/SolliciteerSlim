...
export const metadata: Metadata = {
  title: "Algemene voorwaarden | SolliciteerSlim",
  description: "De algemene voorwaarden van SolliciteerSlim. Lees wat je rechten en plichten zijn als gebruiker van onze dienst.",
};
      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="text-slate-600 leading-7">
            SolliciteerSlim is een online hulpmiddel voor het opstellen en verbeteren van cv&apos;s en sollicitatiebrieven. De dienst is uitsluitend bedoeld voor persoonlijk gebruik. Het is niet toegestaan om:
          </p>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 text-slate-600 mt-3">
            ...
            <li>Het direct melden van ongeautoriseerd gebruik via info@solliciteerslim.nl</li>
          </ul>
          <p className="text-slate-600 leading-7 mt-3">
            SolliciteerSlim behoudt zich het recht voor accounts te blokkeren of te verwijderen bij schending van deze voorwaarden.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-600 leading-7">
            SolliciteerSlim maakt gebruik van AI om suggesties te doen voor je cv en sollicitatiebrief. Houd rekening met het volgende:
          </p>
          <ul className="list-disc list-inside space-y-1 text-slate-600 mt-3">
            ...
            <li>SolliciteerSlim is niet aansprakelijk voor gevolgen van het gebruik van AI-suggesties</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-600 leading-7">
            De dienst wordt geleverd op basis van &ldquo;as is&rdquo; en &ldquo;as available&rdquo;. SolliciteerSlim geeft geen garanties met betrekking tot:
          </p>
          <ul className="list-disc list-inside space-y-1 text-slate-600 mt-3">
          ...
          <p className="text-slate-600 leading-7 mt-3">
            De aansprakelijkheid van SolliciteerSlim is in alle gevallen beperkt tot het bedrag dat je in de afgelopen drie maanden voor de dienst hebt betaald.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-600 leading-7">
            De software, het design, de templates en alle overige elementen van SolliciteerSlim zijn eigendom van SolliciteerSlim en zijn beschermd door intellectueel eigendomsrecht. Het is niet toegestaan deze te kopiëren, distribueren of te gebruiken zonder toestemming.
          </p>
          <p className="text-slate-600 leading-7 mt-3">
            De cv-inhoud die jij invoert, is en blijft jouw eigendom. Door de inhoud in te voeren geef je SolliciteerSlim toestemming deze te verwerken met als enig doel het leveren van de dienst.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-600 leading-7">
            Op deze voorwaarden en het gebruik van SolliciteerSlim is Nederlands recht van toepassing. Geschillen worden voorgelegd aan de bevoegde rechter in het arrondissement Amsterdam, tenzij dwingend recht een andere rechter voorschrijft.
          </p>
        </section>
