...
"financieel-analist": {
  ...
  sections: [
    {
      heading: "Wat verdient een financieel analist in Nederland in 2026?",
      body: [
...
"fiscalist": {
  ...
  sections: [
    {
      heading: "Wat verdient een fiscalist in Nederland in 2026?",
      body: [
...
"advocaat": {
  ...
  sections: [
    {
      heading: "Wat verdient een advocaat in Nederland in 2026?",
      body: [
    ...
    },
    {
      ...
      body: [
        ...
        "Digitale juridische vaardigheden worden in 2026 steeds relevanter: kennis van legal tech-tools, e-discovery-software en contractmanagementsystemen wordt door grote kantoren steeds vaker als voordeel gezien. Meertaligheid, met name vloeiend Engels, is bij vrijwel alle fullservice kantoren een harde vereiste. Ervaring met internationale arbitrage of cross-border transacties verhoogt de waarde van een advocaatsprofiel op de competitieve Amsterdamse markt enorm."
      ]
    },
    {
  ...
  faq: [
    ...
    { q: "Wat zijn de meest gevraagde specialisaties in de Nederlandse advocatuur?", a: "In 2026 zijn arbeidsrecht, privacyrecht (AVG), M&A, bouwrecht en insolventierecht bijzonder gevraagd op de Nederlandse markt. De toenemende digitalisering heeft ook de vraag naar IT-recht en data privacy specialists sterk doen stijgen. Milieurecht en duurzaamheidsrecht zijn opkomende specialisaties die de komende jaren naar verwachting verder aan belang zullen winnen." }
  ]
},
"jurist": {
  ...
  sections: [
    {
      heading: "Wat verdient een jurist in Nederland in 2026?",
      body: [
    ...
    },
    {
      ...
      body: [
        ...
        "Voor in-house juridische functies is kennis van bedrijfsprocessen en een zakelijk pragmatische insteek cruciaal. Een in-house jurist die alleen vanuit een puur juridisch perspectief redeneert zonder oog voor de businessbehoeften, past doorgaans minder goed in een corporate omgeving. Kennis van AVG en privacywetgeving is in 2026 vrijwel universeel vereist, ongeacht de sector of het type organisatie.",
...
"boekhouder": {
  ...
  sections: [
    {
      heading: "Wat verdient een boekhouder in Nederland in 2026?",
      body: [
  ...
  faq: [
    ...
    { q: "Kan ik als boekhouder ook als zzp-er werken?", a: "Ja, zzp-boekhouders zijn populair in Nederland, met name bij kleine bedrijven die geen fulltime boekhouder kunnen betalen maar wel behoefte hebben aan professionele administratieve ondersteuning. Het gemiddelde uurtarief voor een zzp-boekhouder in Nederland ligt in 2026 tussen de EUR 45 en EUR 75 per uur. Goede zzp-boekhouders bouwen via mond-tot-mondreclame snel een clientenportefeuille op." },
...
"controller": {
  ...
  sections: [
    {
      heading: "Wat verdient een controller in Nederland in 2026?",
      body: [
        ...
        "Op je cv als controller is het cruciaal om niet alleen procesverantwoordelijkheid maar ook impact te beschrijven. Benoem welke KPIs je bewaakt, welke managementinformatie je produceerde en welke beslissingen mede op basis van jouw analyses werden genomen. Controleurs die ook lean- of procesoptimalisatie-ervaring hebben, zijn in 2026 extra gewild en kunnen hogere salarissen bedingen dan puur rapporterende collega's."
      ]
    },
    {
      heading: "Welke vaardigheden zijn onmisbaar voor een controller in 2026?",
      body: [
...
"notaris": {
  ...
  sections: [
    {
      heading: "Wat verdient een notaris of kandidaat-notaris in Nederland in 2026?",
      body: [
        "Een kandidaat-notaris met een afgeronde master Notarieel Recht en twee tot vier jaar ervaring verdient gemiddeld tussen de EUR 4.000 en EUR 6.000 bruto per maand. De arbeidsmarkt voor kandidaat-notarissen is in 2026 krap, waardoor de startsalarissen de afgelopen jaren zijn gestegen. Notariskantoren in grote steden als Amsterdam, Rotterdam en Utrecht betalen doorgaans meer dan regionale kantoren, maar ook de werkdruk en het type zaken verschilt aanzienlijk.",
    ...
    {
      heading: "Welke vaardigheden zoeken notariskantoren in 2026?",
      body: [
...
"recruiter": {
  ...
  sections: [
    {
      heading: "Wat verdient een recruiter in Nederland in 2026?",
      body: [
  ...
  faq: [
    ...
    { q: "Is LinkedIn Recruiter onmisbaar voor een recruiter in Nederland?", a: "Ja, LinkedIn Recruiter is in 2026 de standaard sourcingstool voor vrijwel alle professionele recruiters in Nederland. Met meer dan twaalf miljoen Nederlandse gebruikers op LinkedIn is het de meest complete database van actieve en passieve professionals. Werkgevers nemen bijna altijd aan dat recruiters bedreven zijn in Boolean search, InMail-campagnes en het beheren van projecten in LinkedIn Recruiter." },
...
"scholier": {
  salary: {
    ...
    note: "Scholieren werken doorgaans in deeltijd (8-16 uur per week) en verdienen het wettelijk minimumloon voor jongeren. In 2026 bedraagt het jeugdminimumloon voor 15-jarigen €5,28 per uur oplopend tot het volwassen minimumloon (€13,68) bij 21 jaar. Meeste bijbanen zijn in retail, horeca of bezorging.",
  },
  recruiterSkills: [
    "Klantgerichtheid",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "In 2026 is de algemene heffingskorting €3.362 per jaar. Als u minder verdient dan dit bedrag per jaar, betaalt u in principe geen belasting. Vraag bij uw werkgever om loonheffingskorting te activeren zodat er niet onnodig te veel belasting wordt ingehouden op uw loon.",
    },
    {
