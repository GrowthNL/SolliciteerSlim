...
function createStyles(accent: string, font: { regular: string; bold: string }) {
  return StyleSheet.create({
    page: { padding: "40px 48px", fontFamily: font.regular, fontSize: 9.5, color: "#1e293b", lineHeight: 1.4 },
    header: { borderBottomWidth: 2, borderBottomColor: accent, paddingBottom: 10, marginBottom: 14 },
    name: { fontSize: 22, fontFamily: font.bold, color: "#0f172a" },
    jobTitle: { fontSize: 8, fontFamily: font.bold, color: accent, letterSpacing: 1.4, marginTop: 2 },
    ...
    sectionTitle: {
      fontSize: 7, fontFamily: font.bold, color: accent,
      letterSpacing: 1.4, borderBottomWidth: 1, borderBottomColor: accent,
      paddingBottom: 2, marginBottom: 6,
    },
    entryTitle: { fontSize: 9.5, fontFamily: font.bold, color: "#0f172a" },
    ...
    langName: { fontSize: 8.5, color: "#334155", marginBottom: 2, fontFamily: font.bold },
  });
}

export function ModernPdf({ doc, accent, font }: { doc: ResumeDocument; accent?: string; font?: PdfFont }) {
