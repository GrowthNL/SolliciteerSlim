...
function createStyles(accent: string, font: { regular: string; bold: string }) {
  return StyleSheet.create({
    page: { padding: 48, fontFamily: font.regular, fontSize: 9.5, color: "#334155", lineHeight: 1.5 },
    headerAccent: { borderTopWidth: 3, borderTopColor: accent, marginBottom: 8 },
    name: { fontSize: 26, fontFamily: font.bold, color: "#0f172a" },
    ...
    langName: { fontSize: 8.5, color: "#0f172a", marginBottom: 2, fontFamily: font.bold },
    langLevel: { fontSize: 8, color: "#94a3b8", marginBottom: 2 },
    header: { marginBottom: 18 },
  });
}

export function MinimaalPdf({ doc, accent, font }: { doc: ResumeDocument; accent?: string; font?: PdfFont }) {
